document.addEventListener("DOMContentLoaded", function() {
  ...
  //DOM初期化
  const Random_Sentence_Url_Api = "https://api.quotable.io";
  ...
  //DOM初期化（音声関連）
  const typingBgmContent = document.getElementById("bgm_sound_checkbox");
  const typingSoundContent = document.getElementById("typing_sound_checkbox");
  const typingMissSoundContent = document.getElementById("typing_miss_sound_checkbox");
  const clearSoundContent = document.getElementById("clear_sound_checkbox");
  const recoverySoundContent = document.getElementById("recovery_sound_checkbox");
  const gameOverSoundContent = document.getElementById("game_over_sound_checkbox");
  ...
  class sentenceQueue {
    ...
    async setEnqueues() {
      ...
      for (let index = 0; index < sentenceNum; index++) {
        ...
        var sentence = "Now, sentence API is down. Please wait for recover."
